...
// En prod usa los secrets propios (PROJECT_URL/...); en LOCAL cae a las variables que
// Supabase inyecta solo (SUPABASE_*), así las functions corren en local sin config extra.
